...
/// (`Flow`/`Row`/`Ref`), shaped per the design doc §A.4 item 2. This is the Swift side of
/// the pre-parsed-JSON contract (CFM-R1-3): bundled gallery flows ship their `.cat` text
/// for the user and a `*.parse.json` (generated by the Python runtime, the shape of
/// `conformance/*.expect.json` / `tests/conftest.py::flow_to_dict`) for the machine.
///
