...
/// FLUX CLIP text tokenizer, ported from `ml-explore/mlx-examples/flux/flux/tokenizers.py`
/// (`CLIPTokenizer`), itself a port of HuggingFace's `CLIPTokenizer`. Standard BPE over the
/// installed repo's `tokenizer/vocab.json` + `tokenizer/merges.txt`, truncated/padded to
/// CLIP's 77-token window. AM4c.
///
...
nonisolated enum FluxCLIPTokenizer {
