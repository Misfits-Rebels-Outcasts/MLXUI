...
final class FlowEditorModel {
    ...
    /// `_TASK_MODELS` — the small display-name pools per task (the Python's tuples).
    private nonisolated static let llmModels = ["Ministral 3B", "Llama 3.1 8B", "Qwen3 8B",
                                                 "Qwen2.5 14B", "Ternary-Bonsai 4B", "Ternary-Bonsai 8B"]
    private nonisolated static let taskModels: [String: [String]] = [
